...
> 数据来源：2026-06-02 老板 × Fernando Geraldeli（巴西）解约咨询
...
用 Hofstede 数据（特别是 UA 和 LTO）校准老板对人的判断：

| 老板说 | Hofstede 验证 | 谈判影响 |
|:--|:--|:--|
...
用 `scripts/render_mobile_pdf.py` 生成手机竖版 PDF（见 SKILL.md §十三），包含：
- 合同核心条款速查表
- 时间线
- Hofstede 跨文化对照表
- 推荐话术（英文，可直接念）
...
存档路径：`output/{地区}/{人物}_解约谈判备忘录_日期.pdf`

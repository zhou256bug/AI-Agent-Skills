...
Skill 路径：`~/Projects/AI-Agent-Skills/aliyun-enterprise-mail/`
...
```bash
openclaw skills install ~/Projects/AI-Agent-Skills/aliyun-enterprise-mail --as aliyun-enterprise-mail
# 或安装到全局：
openclaw skills install ~/Projects/AI-Agent-Skills/aliyun-enterprise-mail --global
```
...
```bash
SKILL_DIR=~/Projects/AI-Agent-Skills/aliyun-enterprise-mail
...
```bash
ln -sf ~/Projects/AI-Agent-Skills/aliyun-enterprise-mail \
...
cp ~/Projects/AI-Agent-Skills/aliyun-enterprise-mail/bundles/mail-assistant.hermes.yaml \
